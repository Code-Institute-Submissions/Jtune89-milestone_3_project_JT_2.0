...
# user_information
    ...
    print
    ("\nWelcome", player_name, "& good luck!  Lets start with question 1:")
...
# QUESTION 5
    ...
    if question5 == "d" or question5 == "South Dakota" or question5 == "D" or question5 == "south dakota":
        score += 1
...
#game over message
    ...
    if score >= 0:
        leaderboard += player_name + ' ' + str(score) + '\n'
